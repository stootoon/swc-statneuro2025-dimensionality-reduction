...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org0ded918}]{Data compression / approximation / denoising}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org0b9ab9a}]{Key idea behind PCA}
   \begin{center}
\Large
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf172cf7}]{Key idea behind PCA}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgab95f7e}]{Outline}
\begin{enumerate}
\item Single neurons
\begin{itemize}
...
\end{center}  
\end{frame}
\begin{frame}[label={sec:org21a6e99}]{Standard coordinates}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga97bcef}]{Coordinates are orthonormal}
\vspace{-0.25cm}
\begin{center}
\includegraphics[width=1.0\textwidth]{figures/one_odour_response.png}
\end{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga5d3301}]{Variance of a single neuron}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcd2fabd}]{Covariance of neural populations}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org399c2b8}]{Covariance matrix}
\begin{itemize}
...
\label{sec:org38f06a9}
\begin{frame}[label={sec:org597e149}]{Where we're going}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb8e6065}]{Variance of a pseudo-neuron along \(\uu_1\)}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org699a0e3}]{Variance of \emph{any} pseudoneuron}
\begin{itemize}
...
\label{sec:orgc124dea}
\begin{frame}[label={sec:org2551344}]{Matrices}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1aaafe6}]{Different ways to view matrices}
...
\end{frame}
\begin{frame}[label={sec:orga31f824}]{Matrix operations}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf620d2c}]{Example Matrices}
\centering
\begin{array}{l c l}
...
\end{array}
\end{frame}
\begin{frame}[label={sec:org3f55cbf}]{Composing transformations}
\begin{itemize}
...
\label{sec:orgc710042}
\begin{frame}[label={sec:org0972dd1}]{All matrices are diagonal matrices (in the right coordinates)}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1bd0e79}]{Three parts of Singular Value Decomposition}
$$ \AA  = \underbrace{\UU}_{\text{rotate}} \underbrace{\SS}_{\text{scale}} \underbrace{\VV^T}_{\text{project}}.$$
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf44baa2}]{Three transformations in Singular Value Decomposition}
\begin{figure}[htbp]
\centering
...
\end{figure}  
\end{frame}
\begin{frame}[label={sec:orgde2d8b8}]{Three matrices of Singular Value Decomposition}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org12e8b91}]{Three steps of Singular Value Decomposition}
...
\begin{frame}[label={sec:orgdaec77b}]{SVD of covariance matrices}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5347c00}]{SVD and eigendecomposition}
\begin{itemize}
...
\begin{frame}[label={sec:org4593e13}]{Maximum variance direction from SVD}
\begin{itemize}
...
\label{sec:org62f774a}
\begin{frame}[label={sec:org2909573}]{Finally: Dimension Reduction with PCA}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7add601}]{Examining the Principal Components}
\begin{center}
\includegraphics[width=1.0\textwidth]{figures/pca_projections_pcs.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2cbf73a}]{Measuring dimensionality with Participation Ratio}
\begin{itemize}
...
\end{center}  
\end{frame}
\begin{frame}[label={sec:orgad854a2}]{Approximation/Denoising with PCA}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org9c9656e}]{Approximation/Denoising with PCA}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orga537d12}]{How many dimensions to keep?}
\begin{itemize}
...
\label{sec:org4b3f069}
\begin{frame}[label={sec:org88c0f05}]{Exploiting nonlinearity with Kernel PCA}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgdd9f4a7}]{Comparing different datasets with CCA}
\begin{itemize}
...
\end{center}  
\end{frame}
\begin{frame}[label={sec:orgefe9b50}]{Supervised learning with LDA}
\begin{itemize}
...
\end{frame}
\section{Summary}
\label{sec:orgcb87a1a}
\begin{frame}[label={sec:org3cb8743}]{Summary}
\begin{itemize}
